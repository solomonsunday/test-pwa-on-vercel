...
import { IAdminPermissionsDefinitions } from "./base.interface";


export const DefinedAdminUrl = {
	dashboard: {
		name: 'Dashboard',
...
export const DefinedAdminPermissions: IAdminPermissionsDefinitions = {
	event: {
		add: 'add-event',
		edit: 'edit-event',
		delete: 'delete-event'
...
export function faqsDummy(): { question: string; answer: string; id: number; }[] {
	return [{
	...
	},
	{
		...
		answer: 'Etiam ac quam nec ante efficitur consequat non a ante. Vestibulum non justo sit amet ante gravida venenatis. Etiam suscipit sem ut nunc placerat pulvinar vitae eget nibh. Donec fringilla dolor in placerat tristique. Nulla nec leo pretium, dignissim eros eget, pharetra eros. Sed eu turpis aliquam, volutpat mi nec, faucibus nisl. Etiam convallis eu elit vitae auctor.',
		id: 51,
	},
	{
	...
	},
	{
		...
		answer: 'CEtiam ac quam nec ante efficitur consequat non a ante. Vestibulum non justo sit amet ante gravida venenatis. Etiam suscipit sem ut nunc placerat pulvinar vitae eget nibh. Donec fringilla dolor in placerat tristique. Nulla nec leo pretium, dignissim eros eget, pharetra eros. Sed eu turpis aliquam, volutpat mi nec, faucibus nisl. Etiam convallis eu elit vitae auctor.',
		id: 56
	}]
}

export function getCountryRawCodes() {
